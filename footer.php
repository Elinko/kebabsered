 ...
 */
 ...
 $kontakt_text_zimny = get_field('kontakt_text_zimny', 7);
 $kontakt_text_letny = get_field('kontakt_text_letny', 7);
	...
	<footer id="footer">
	  ...
	  <div class="container text-center">
	    <div class="col-md-7">
          ...
          <div class="row">
            <div class="col-md-6">
              <?php echo $kontakt_text_letny; ?>
            </div>
            <div class="col-md-6">
              <?php echo $kontakt_text_zimny; ?>
            </div>
          </div>
	      </div>
	    </div>
